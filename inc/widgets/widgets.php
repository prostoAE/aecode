 ...
 */
function aecode_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'aecode' ),
		'id'            => 'news-sidebar',
		'description'   => esc_html__( 'Add widgets here.', 'aecode' ),
...
add_action( 'widgets_init', 'aecode_widgets_init' );

/**
 * Register Theme Widgets
 */
function wayup_init_widgets() {
  register_widget('Aecode_Customsearch_Widget');
  register_widget('Aecode_Blogcategory_Widget');
  register_widget('Aecode_Blogtags_Widget');
}
