...
Redux::setSection( $opt_name, array(
	...
	'id'               => 'basic',
	'desc'             => __( 'Глобальные настройки сайта', 'redux-framework-demo' ),
	'customizer_width' => '400px',
	'icon'             => 'el el-home'
) );
Redux::setSection( $opt_name, array(
	'title'            => __( 'Ссылки и контакты', 'redux-framework-demo' ),
	'id'               => 'basic-links',
	'subsection'       => true,
	...
	'fields'           => array(
		array(
			'id'    => 'fb-link',
			'type'  => 'text',
			'title' => __( 'Ссылка на ФБ', 'redux-framework-demo' ),
//			'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
			'desc'  => __( 'Вставьте ссылку на ресурс', 'redux-framework-demo' ),
//			'default'  => 'Default Text',
		),
		array(
			'id'    => 'tw-link',
			'type'  => 'text',
			'title' => __( 'Ссылка на TW', 'redux-framework-demo' ),
			'desc'  => __( 'Вставьте ссылку на ресурс', 'redux-framework-demo' ),
		),
		array(
			'id'    => 'youtube-link',
			'type'  => 'text',
			'title' => __( 'Ссылка на YouTube', 'redux-framework-demo' ),
			'desc'  => __( 'Вставьте ссылку на ресурс', 'redux-framework-demo' ),
		),
		array(
			'id'    => 'inst-link',
		...
		array(
			...
			'desc'  => __( 'Укажите адрес', 'redux-framework-demo' ),
		),
		array(
			'id'    => 'mail-contact',
			'type'  => 'text',
			'title' => __( 'Эл. почта для связи', 'redux-framework-demo' ),
			'desc'  => __( 'Укажите электронную почту', 'redux-framework-demo' ),
		),
		array(
			'id'    => 'skype-contact',
			'type'  => 'text',
			'title' => __( 'Скайп для связи', 'redux-framework-demo' ),
			'desc'  => __( 'Укажите свой скайп', 'redux-framework-demo' ),
		),
		array(
			'id'    => 'phone-contact',
			'type'  => 'text',
			'title' => __( 'Телефон для связи', 'redux-framework-demo' ),
			'desc'  => __( 'Укажите телефон', 'redux-framework-demo' ),
		),
	)
) );
Redux::setSection( $opt_name, array(
	'title'            => __( 'Главный екран', 'redux-framework-demo' ),
	'id'               => 'home-screen',
	'subsection'       => true,
	'customizer_width' => '450px',
	'desc'             => __( 'For full documentation on this field, visit: ', 'redux-framework-demo' ) . '<a href="//docs.reduxframework.com/core/fields/checkbox/" target="_blank">docs.reduxframework.com/core/fields/checkbox/</a>',
	'fields'           => array(
		array(
			'id'    => 'offer-title',
			'type'  => 'text',
			'title' => __( 'Главный заголовок', 'redux-framework-demo' ),
			'desc'  => __( 'Напишите главный заголовок', 'redux-framework-demo' ),
		),
		array(
			'id'       => 'offer-gallery',
			'type'     => 'gallery',
			'title'    => __( 'Изображения для слайдера Офера', 'redux-framework-demo' ),
			'subtitle' => '',
			'desc'     => '',
		),
		array(
			'id'    => 'about-title',
			'type'  => 'text',
			'title' => __( 'Заголовок блока Обо мне', 'redux-framework-demo' ),
			'desc'  => __( 'Укажите заголовок обо мне', 'redux-framework-demo' ),
		),
		array(
			'id'           => 'about-desc',
			'type'         => 'textarea',
			'title'        => __( 'Описание Обо мне', 'redux-framework-demo' ),
			'subtitle'     => '',
			'desc'         => __( 'Напишите описание для блока Обо мне', 'redux-framework-demo' ),
		...
		array(
			...
			'type'     => 'media',
			'url'      => true,
			'title'    => __( 'Ссылка на фото', 'redux-framework-demo' ),
			'desc'     => __( 'Выберите фото', 'redux-framework-demo' ),
		...
		array(
			...
			'type'  => 'text',
			'title' => __( 'Шорткод формы для связи', 'redux-framework-demo' ),
			'desc'  => 'Вставьте Шорткод формы из плагина Contacts Form 7',
		),
	)
) );
Redux::setSection( $opt_name, array(
	...
	'fields'           => array(
		array(
			...
			'type'  => 'text',
			'title' => __( 'Копирайт первая строка', 'redux-framework-demo' ),
			'desc'  => '',
		),
		array(
			'id'    => 'footer-copyright2',
			'type'  => 'text',
			'title' => __( 'Копирайт вторая строка', 'redux-framework-demo' ),
			'desc'  => '',
		),
		array(
			'id'    => 'footer-subscribe-text',
			'type'  => 'text',
			'title' => __( 'Текст подписки на новости', 'redux-framework-demo' ),
			'desc'  => '',
		),
		array(
			'id'    => 'footer-subscribe-shortcode',
			'type'  => 'text',
			'title' => __( 'Шорткод формы подписки', 'redux-framework-demo' ),
			'desc'  => '',
		),
	)
) );
Redux::setSection( $opt_name, array(
	'title'            => __( 'Портфолио', 'redux-framework-demo' ),
	...
	'fields'           => array(
		array(
			...
			'type'     => 'media',
			'url'      => true,
			'title'    => __( 'Ссылка на фото банера', 'redux-framework-demo' ),
			'desc'     => __( 'Выберите фото', 'redux-framework-demo' ),
			'subtitle' => __( '', 'redux-framework-demo' ),
			'default'  => ''
		),
...
Redux::setSection( $opt_name, array(
	'title'            => __( 'Обо мне', 'redux-framework-demo' ),
	'id'               => 'about-section',
	'subsection'       => true,
	'customizer_width' => '450px',
	'desc'             => __( 'For full documentation on this field, visit: ', 'redux-framework-demo' ) . '<a href="//docs.reduxframework.com/core/fields/checkbox/" target="_blank">docs.reduxframework.com/core/fields/checkbox/</a>',
	'fields'           => array(
		...
		array(
			...
			'type'     => 'media',
			'url'      => true,
			'title'    => __( 'Ссылка на фото в описании обо мне', 'redux-framework-demo' ),
			'desc'     => __( 'Выберите фото', 'redux-framework-demo' ),
			'subtitle' => __( '', 'redux-framework-demo' ),
			'default'  => ''
		),
		array(
			'id'    => 'page-about-title',
			'type'  => 'text',
			'title' => __( 'Заголовок описания обо мне', 'redux-framework-demo' ),
			'desc'  => '',
		),
		array(
			'id'           => 'page-about-desc',
			...
			'title'        => __( 'Описание Обо мне', 'redux-framework-demo' ),
			'subtitle'     => '',
			'desc'         => __( 'Напишите описание для страницы Обо мне', 'redux-framework-demo' ),
			'validate'     => 'html_custom',
			'default'      => '',
			'allowed_html' => array(
				'a'      => array(
		...
		array(
			'id'          => 'sertificats-slides',
			'type'        => 'slides',
			'title'       => __( 'Слайд', 'redux-framework-demo' ),
		...
		array(
			'id'    => 'about-form',
			'type'  => 'text',
			'title' => __( 'Шорткод формы', 'redux-framework-demo' ),
			'desc'  => 'Вставьте шорткод формы из плагина CF7',
		),
	)
) );
Redux::setSection( $opt_name, array(
	'title'            => __( 'Услуги', 'redux-framework-demo' ),
	'id'               => 'service-section',
	'subsection'       => true,
	'customizer_width' => '450px',
	'desc'             => __( 'For full documentation on this field, visit: ', 'redux-framework-demo' ) . '<a href="//docs.reduxframework.com/core/fields/checkbox/" target="_blank">docs.reduxframework.com/core/fields/checkbox/</a>',
...
Redux::setSection( $opt_name, array(
	'title'            => __( 'Контакты', 'redux-framework-demo' ),
	'id'               => 'contacts-section',
	'subsection'       => true,
	'customizer_width' => '450px',
	'desc'             => __( 'For full documentation on this field, visit: ', 'redux-framework-demo' ) . '<a href="//docs.reduxframework.com/core/fields/checkbox/" target="_blank">docs.reduxframework.com/core/fields/checkbox/</a>',
	'fields'           => array(
		...
		array(
			'id'    => 'form-caption',
			'type'  => 'text',
			'title' => __( 'Заголовок формы', 'redux-framework-demo' ),
			'desc'  => 'Вставьте заголовок над формой',
		),
		array(
			'id'    => 'form-shortcode',
			'type'  => 'text',
		...
		array(
			'id'    => 'map-shortcode',
			'type'  => 'text',
			'title' => __( 'Шорткод Карты', 'redux-framework-demo' ),
			'desc'  => 'Вставьте шорткод карты из плагина WP Google Map',
		),
	)
) );
